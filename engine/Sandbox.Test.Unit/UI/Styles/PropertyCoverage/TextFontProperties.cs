...
/// Normal [TestMethod]s assert the actual parsed value and are expected to pass.
/// Methods ending in _Gap document known web-syntax gaps and are expected to fail
/// until the engine is fixed.
/// </summary>
[TestClass]
public class TextFontProperties
{
	// ---------------------------------------------------------------------
